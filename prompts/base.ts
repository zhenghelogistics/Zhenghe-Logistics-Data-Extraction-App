...
- M. (SGD) OTHERS CHARGES: ONLY include these specific charges (sum them if multiple apply): EDI Transmission Fee / Export Service Fee, Certificate Issue Fee, MISC CHARGES, ADDING SEAL, ASR, Interchange Cona, ICS2 Filing, ICS2, EES EUROPE, UNLOCK BL FEE, CDD CARGO, SURRENDER BL / Surrender Fee / SBL, FOOD GRADE / Food Grade Certificate / FOOD GRADE CHG. If a charge is in USD, convert to SGD using the exchange rate shown on the BL (e.g. EES EUROPE USD 186.00 × SGD/1.280400 = SGD 238.15 → return "238.15"; FOOD GRADE USD 90.00 × SGD/1.32000 = SGD 118.80 → return "118.80"). Do NOT include ISOCC or any other charges not listed here.
- N. REMARKS: List the names of ALL charges included in 'Others Charges', comma-separated (e.g. "SURRENDER BL, FOOD GRADE" if both are present; "EES EUROPE" if only that charge applies).
