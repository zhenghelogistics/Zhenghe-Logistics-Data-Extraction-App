...
- L. (SGD) ENS / AMS / SCMC: ENS Filing, AMS, AFR, SCMC, ADV MFST CHGR, Cargo Data Declaration total. If the charge is in USD, convert to SGD using the exchange rate shown on the invoice (e.g. USD 30.00 × 1.27270 = SGD 38.18 → return "38.18"). Return the SGD equivalent amount.
