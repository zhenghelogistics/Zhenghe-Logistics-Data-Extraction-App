...
import { ContainerBillingRecord } from '../services/supabase';
import {
  useCrmBilling, CrmBillingProps, CrmView,
  CHARGE_LABELS, NON_BILLABLE_KEYS, BILLABLE_CHARGE_KEYS, AMBER, GREEN,
  billableCharges, triggerCSVDownload, formatMonthLabel, parseAmount,
} from '../hooks/useCrmBilling';

export default function CrmBillingTab(props: CrmBillingProps) {
  const {
    view, setView,
